...
__all__ = [
    'RowOrColumnMajor', 'IUIAutomationNotificationEventHandler',
    'NotificationProcessing_All',
    'AnnotationType_EditingLockedChange', 'UIA_IsDialogPropertyId',
    'NotificationKind_Other', 'UIA_GridItemColumnSpanPropertyId',
    'UIA_IsSelectionPatternAvailablePropertyId',
    'UIA_NativeWindowHandlePropertyId',
    'UIA_AnnotationTypesAttributeId', 'UIA_FontSizeAttributeId',
    'StyleId_Emphasis', 'UIA_MultipleViewCurrentViewPropertyId',
    'AnnotationType_Comment', 'UIA_MarginTopAttributeId',
    'UIA_DropTarget_DragEnterEventId', 'UIA_ValuePatternId',
    'UIA_OptimizeForVisualContentPropertyId',
    'NotificationProcessing_MostRecent',
    'IUIAutomationTableItemPattern', 'UIA_AccessKeyPropertyId',
    'UIA_ProgressBarControlTypeId', 'UIA_SpinnerControlTypeId',
    'UIA_ControlTypePropertyId', 'UIA_ProviderDescriptionPropertyId',
    'AnnotationType_ConflictingChange',
    'UIA_SelectionItem_ElementSelectedEventId',
    'NotificationProcessing',
    'UIA_IsTogglePatternAvailablePropertyId',
    'UIA_CapStyleAttributeId', 'UIA_MainLandmarkTypeId',
    'UIA_IndentationFirstLineAttributeId',
    'AutomationElementMode_Full', 'UIA_DragPatternId',
    'UIA_InputReachedTargetEventId', 'IUIAutomationGridItemPattern',
    'Polite', 'WindowVisualState_Maximized', 'OrientationType',
    'AnnotationType_Author', 'UIA_IsActiveAttributeId',
    'UIA_TogglePatternId', 'StructureChangeType_ChildrenReordered',
    'IUIAutomationInvokePattern', 'UIA_SpreadsheetItemPatternId',
    'IUIAutomationElement3',
    'UIA_IsSpreadsheetItemPatternAvailablePropertyId',
    'ToggleState_Off', 'DockPosition',
    'ProviderOptions_NonClientAreaProvider', 'WindowVisualState',
    'UIA_TableItemPatternId', 'NotificationKind_ActionAborted',
    'UIA_FlowsToPropertyId', 'UIA_ScrollPatternId',
    'AnnotationType_Sensitive',
    'UIA_LegacyIAccessibleChildIdPropertyId',
    'UIA_LocalizedLandmarkTypePropertyId',
    'SynchronizedInputType_RightMouseUp', 'UIA_Invoke_InvokedEventId',
    'UIA_LegacyIAccessibleHelpPropertyId',
    'UIA_IsPeripheralPropertyId', 'UIA_AutomationIdPropertyId',
    'IUIAutomationElementArray', 'UIA_StyleIdAttributeId',
    'UIA_FillColorPropertyId', 'UIA_IndentationTrailingAttributeId',
    ...
    'IUIAutomationVirtualizedItemPattern', 'StyleId_Subtitle',
    'IUIAutomationTextEditTextChangedEventHandler', 'CUIAutomation',
    'UIA_ValueIsReadOnlyPropertyId',
    'IUIAutomationActiveTextPositionChangedEventHandler',
    'IUIAutomationTogglePattern', 'ProviderOptions_UseComThreading',
    'UIA_LineSpacingAttributeId', 'SynchronizedInputType',
    'IUIAutomationTextRange2', 'UIA_ScrollVerticalViewSizePropertyId',
    'TextPatternRangeEndpoint', 'UIA_IndentationLeadingAttributeId',
    'DockPosition_Bottom', 'UIA_HyperlinkControlTypeId',
    'SupportedTextSelection_None',
    'UIA_IsValuePatternAvailablePropertyId',
    'UIA_OverlineStyleAttributeId', 'StyleId_NumberedList',
    ...
    'UIA_ScrollItemPatternId', 'UIA_TableControlTypeId',
    'UIA_IsScrollItemPatternAvailablePropertyId',
    'ConnectionRecoveryBehaviorOptions', 'UIA_DropTargetPatternId',
    'IUIAutomationChangesEventHandler',
    'UIA_AnnotationObjectsPropertyId', 'UIA_CulturePropertyId',
    'UIA_MarginTrailingAttributeId', 'OrientationType_Horizontal',
    'UIA_TextPattern2Id', 'TextEditChangeType_AutoCorrect',
    'TextUnit_Word', 'UIA_Transform2ZoomLevelPropertyId',
    'UIA_LegacyIAccessibleKeyboardShortcutPropertyId',
    'ToggleState_Indeterminate', 'UIA_MenuControlTypeId',
    'UIA_TransformCanRotatePropertyId',
    'NavigateDirection_FirstChild', 'UIA_TextEdit_TextChangedEventId',
    'UIA_ObjectModelPatternId',
    'UIA_WindowWindowVisualStatePropertyId', 'StyleId_Heading8',
    'CoalesceEventsOptions_Enabled', 'UIA_LevelPropertyId',
    'TextPatternRangeEndpoint_End',
    'UIA_SelectionActiveEndAttributeId',
    'UIA_SelectionItem_ElementAddedToSelectionEventId',
    'IUIAutomationSpreadsheetItemPattern',
    'TreeTraversalOptions_Default', 'UIA_GridItemPatternId',
    ...
    'IUIAutomationTransformPattern', 'AnnotationType_InsertionChange',
    'UIA_SliderControlTypeId', 'UIA_LegacyIAccessibleRolePropertyId',
    'IUIAutomation6', 'ProviderOptions_UseClientCoordinates',
    'ScrollAmount_LargeIncrement',
    'UIA_SelectionIsSelectionRequiredPropertyId',
    'UIA_Text_TextSelectionChangedEventId',
    'UIA_Text_TextChangedEventId', 'UIA_TransformCanResizePropertyId',
    'UIA_WindowWindowInteractionStatePropertyId',
    'UIA_TitleBarControlTypeId', 'IUIAutomationTransformPattern2',
    'SynchronizedInputType_LeftMouseUp',
    'WindowInteractionState_Closing', 'ExtendedProperty',
    'TreeTraversalOptions_PostOrder', 'UIA_CenterPointPropertyId',
    'UIA_GroupControlTypeId', 'UIA_GridItemContainingGridPropertyId',
    'DockPosition_Right', 'TreeScope_Children',
    'WindowInteractionState_NotResponding',
    'UIA_Drag_DragCancelEventId',
    'UIA_IsSynchronizedInputPatternAvailablePropertyId',
    'UIA_DragGrabbedItemsPropertyId', 'TextUnit_Character',
    'TextUnit_Format', 'WindowInteractionState_BlockedByModalWindow',
    'UIA_RadioButtonControlTypeId', 'IUIAutomationValuePattern',
    'UIA_IsTableItemPatternAvailablePropertyId', 'StyleId_Title',
    'UIA_AriaRolePropertyId', 'AnnotationType_FormatChange',
    'HeadingLevel6', 'NotificationKind_ActionCompleted',
    ...
    'UIA_ComboBoxControlTypeId', 'DockPosition_None',
    'IUIAutomation2', 'IUIAutomationElement7',
    'UIA_RangeValueIsReadOnlyPropertyId', 'UIA_SizePropertyId',
    'UIA_IsDockPatternAvailablePropertyId',
    'UIA_MenuItemControlTypeId', 'HeadingLevel8',
    'UIA_GridColumnCountPropertyId',
    'StructureChangeType_ChildrenBulkAdded',
    'WindowVisualState_Minimized', 'UIA_SummaryChangeId',
    'UIA_IsOffscreenPropertyId', 'UIA_CaretPositionAttributeId',
    'UIA_LayoutInvalidatedEventId', 'WindowVisualState_Normal',
    'UIA_FontNameAttributeId', 'UIA_AnnotationObjectsAttributeId',
    'UIA_StatusBarControlTypeId',
    'IUIAutomationExpandCollapsePattern', 'TreeScope_Subtree',
    'UIA_HorizontalTextAlignmentAttributeId',
    'ProviderOptions_OverrideProvider', 'IUIAutomationScrollPattern',
    ...
    'UIA_StructureChangedEventId', 'UIA_ListControlTypeId',
    'IUIAutomationCondition', 'UIA_RangeValueLargeChangePropertyId',
    'UIA_AppBarControlTypeId', 'AnnotationType_FormulaError',
    'IUIAutomationRangeValuePattern', 'UIA_HeaderItemControlTypeId',
    'SynchronizedInputType_LeftMouseDown',
    'UIA_Drag_DragStartEventId', 'ExpandCollapseState_Expanded',
    'Off', 'UIA_TableItemRowHeaderItemsPropertyId',
    'IUIAutomationTextRange3', 'UIA_TextControlTypeId',
    'StyleId_Normal', 'UIA_CustomLandmarkTypeId', 'IUIAutomation4',
    'UIA_StrikethroughStyleAttributeId', 'IUIAutomationStylesPattern',
    'AnnotationType_CircularReferenceError', 'IAccessible',
    'UIA_BulletStyleAttributeId', 'ScrollAmount_LargeDecrement',
    'IUIAutomationDockPattern',
    'StructureChangeType_ChildrenInvalidated',
    'IUIAutomationSelectionPattern2',
    'UIA_TableItemColumnHeaderItemsPropertyId', 'UiaChangeInfo',
    'UIA_StrikethroughColorAttributeId',
    'UIA_LegacyIAccessibleStatePropertyId', 'ZoomUnit_LargeIncrement',
    'ToggleState', 'UIA_LiveSettingPropertyId',
    'SupportedTextSelection', 'UIA_AnnotationTypesPropertyId',
    'UIA_LandmarkTypePropertyId', 'ToggleState_On',
    'IUIAutomationMultipleViewPattern', 'UIA_TextPatternId',
    'UIA_ToolTipControlTypeId', 'UIA_SelectionSelectionPropertyId',
    'UIA_VirtualizedItemPatternId',
    'UIA_SpreadsheetItemAnnotationObjectsPropertyId',
    'StyleId_Heading5', 'UIA_IsTextPatternAvailablePropertyId',
    'UIA_ScrollHorizontallyScrollablePropertyId',
    'UIA_StylesStyleIdPropertyId', 'UIA_MenuOpenedEventId',
    'IUIAutomationElement9', 'UIA_Transform2ZoomMinimumPropertyId',
    'UIA_RuntimeIdPropertyId', 'UIA_ProcessIdPropertyId',
    'UIA_StyleNameAttributeId', 'AnnotationType_Endnote',
    'UIA_StylesPatternId', 'UIA_NotificationEventId',
    'UIA_SemanticZoomControlTypeId', 'AutomationElementMode',
    'UIA_Selection2CurrentSelectedItemPropertyId',
    'UIA_CustomControlTypeId', 'HeadingLevel1',
    'NotificationKind_ItemAdded', 'UIA_RangeValueValuePropertyId',
    'HeadingLevel_None', 'UIA_IsContentElementPropertyId',
    'PropertyConditionFlags_MatchSubstring',
    'ProviderOptions_ServerSideProvider', 'UIA_WindowControlTypeId',
    'UIA_IsGridItemPatternAvailablePropertyId',
    'UIA_ScrollHorizontalViewSizePropertyId',
    'UIA_NavigationLandmarkTypeId', 'UIA_TablePatternId',
    'ConnectionRecoveryBehaviorOptions_Disabled',
    'UIA_AnnotationTargetPropertyId', 'UIA_RangeValuePatternId',
    'UIA_MenuModeStartEventId',
    'UIA_IsTransformPatternAvailablePropertyId',
    'ScrollAmount_SmallIncrement', 'UIA_UnderlineColorAttributeId',
    'UIA_BackgroundColorAttributeId', 'UIA_ButtonControlTypeId',
    'Assertive', 'IUIAutomation5', 'UIA_MarginBottomAttributeId',
    'UIA_FullDescriptionPropertyId', 'UIA_LegacyIAccessiblePatternId',
    'ProviderOptions_ProviderOwnsSetFocus',
    'UIA_ExpandCollapsePatternId', 'UIA_AnnotationDateTimePropertyId',
    'UIA_BoundingRectanglePropertyId', 'UIA_MenuBarControlTypeId',
    'UIA_IsEnabledPropertyId', 'UIA_Window_WindowClosedEventId',
    'UIA_SayAsInterpretAsMetadataId', 'TreeScope',
    'NavigateDirection_PreviousSibling',
    'UIA_IsRequiredForFormPropertyId', 'TreeScope_Parent',
    'UIA_SelectionItem_ElementRemovedFromSelectionEventId',
    'IUIAutomationCustomNavigationPattern',
    'UIA_AutomationPropertyChangedEventId', 'StyleId_Custom',
    'CoalesceEventsOptions_Disabled',
    'UIA_RangeValueMinimumPropertyId',
    'TextPatternRangeEndpoint_Start', 'UIA_DocumentControlTypeId',
    'UIA_TableRowOrColumnMajorPropertyId',
    'UIA_DragDropEffectsPropertyId',
    'UIA_IsScrollPatternAvailablePropertyId',
    'UIA_SpreadsheetItemAnnotationTypesPropertyId',
    'IUIAutomationTablePattern', 'StyleId_Heading7',
    'UIA_LiveRegionChangedEventId', 'TextUnit_Page', 'TextUnit',
    'ZoomUnit_SmallIncrement',
    'UIA_SelectionCanSelectMultiplePropertyId',
    'UIA_IsDataValidForFormPropertyId',
    'UIA_DropTarget_DragLeaveEventId', 'IUIAutomation',
    'UIA_SeparatorControlTypeId', 'IUIAutomationSelectionItemPattern',
    ...
    'UIA_FlowsFromPropertyId', 'ScrollAmount_NoAmount',
    'ZoomUnit_NoAmount', 'HeadingLevel9', 'UIA_ImageControlTypeId',
    'UIA_GridPatternId',
    'UIA_IsMultipleViewPatternAvailablePropertyId',
    'ProviderOptions_ClientSideProvider',
    'SupportedTextSelection_Single', 'UIA_GridItemColumnPropertyId',
    'StyleId_BulletedList', 'TreeTraversalOptions',
    'UIA_LegacyIAccessibleNamePropertyId',
    'UIA_IsItemContainerPatternAvailablePropertyId',
    'StyleId_Heading2', 'IUIAutomationFocusChangedEventHandler',
    'UIA_InvokePatternId', 'UIA_AsyncContentLoadedEventId',
    'UIA_CultureAttributeId', 'UIA_DockDockPositionPropertyId',
    'UIA_Window_WindowOpenedEventId',
    'SupportedTextSelection_Multiple',
    'SynchronizedInputType_KeyDown', 'IUIAutomationEventHandlerGroup',
    'UIA_OutlineStylesAttributeId', 'IUIAutomationProxyFactory',
    'IUIAutomationSelectionPattern', 'DockPosition_Fill',
    'TreeScope_Descendants', 'UIA_LinkAttributeId',
    ...
    'UIA_IsGridPatternAvailablePropertyId', 'IUIAutomationElement5',
    'UIA_DropTargetDropTargetEffectsPropertyId',
    'IUIAutomationScrollItemPattern',
    'UIA_LegacyIAccessibleDescriptionPropertyId', 'HeadingLevel2',
    'UIA_TextFlowDirectionsAttributeId',
    'UIA_CustomNavigationPatternId', 'AnnotationType_Footnote',
    'TreeTraversalOptions_LastToFirstOrder',
    'UIA_DragIsGrabbedPropertyId', 'UIA_AcceleratorKeyPropertyId',
    'UIA_DataGridControlTypeId', 'AnnotationType_Footer',
    'IUIAutomationTextEditPattern', 'UIA_ListItemControlTypeId',
    'HeadingLevel3', 'IUIAutomationLegacyIAccessiblePattern',
    'UIA_CalendarControlTypeId', 'TextEditChangeType_AutoComplete',
    'UIA_TextChildPatternId', 'AnnotationType_ExternalChange',
    'UIA_TableColumnHeadersPropertyId', 'ScrollAmount',
    'AnnotationType_UnsyncedChange', 'WindowInteractionState_Running',
    'StructureChangeType_ChildAdded', 'NavigateDirection',
    'IUIAutomationStructureChangedEventHandler',
    'AnnotationType_DeletionChange', 'TextUnit_Document',
    'RowOrColumnMajor_Indeterminate', 'UIA_OrientationPropertyId',
    'ZoomUnit_LargeDecrement', 'IUIAutomationProxyFactoryMapping',
    'UIA_AriaPropertiesPropertyId',
    'ProviderOptions_RefuseNonClientSupport', 'StyleId_Quote',
    'UIA_MenuModeEndEventId', 'IUIAutomationAndCondition',
    'IUIAutomationElement2', 'IUIAutomation3',
    'AnnotationType_Highlighted', 'UIA_GridItemRowSpanPropertyId',
    'UIA_EditControlTypeId', 'UIA_FontWeightAttributeId',
    'UIA_IsLegacyIAccessiblePatternAvailablePropertyId',
    'UIA_OverlineColorAttributeId', 'UIA_ClickablePointPropertyId',
    'UIA_TreeItemControlTypeId',
    'UIA_SelectionItemIsSelectedPropertyId',
    'UIA_AnnotationAuthorPropertyId', 'UIA_OutlineColorPropertyId',
    'PropertyConditionFlags', 'UIA_BeforeParagraphSpacingAttributeId',
    'UIA_ExpandCollapseExpandCollapseStatePropertyId',
    'UIA_Selection2LastSelectedItemPropertyId',
    'UIA_TabItemControlTypeId',
    'UIA_AfterParagraphSpacingAttributeId',
    'IUIAutomationPropertyChangedEventHandler', 'DockPosition_Left',
    'IUIAutomationTextRangeArray', 'TextUnit_Line',
    'UIA_IsControlElementPropertyId', 'ProviderOptions',
    'UIA_IsDropTargetPatternAvailablePropertyId',
    'UIA_ScrollBarControlTypeId', 'UIA_SayAsInterpretAsAttributeId',
    'StyleId_Heading4', 'IUIAutomationAnnotationPattern',
    'UIA_LabeledByPropertyId', 'UIA_RangeValueMaximumPropertyId',
    'UIA_IsExpandCollapsePatternAvailablePropertyId',
    'UIA_SystemAlertEventId', 'IUIAutomationItemContainerPattern',
    'UIA_LegacyIAccessibleSelectionPropertyId',
    'UIA_IsHiddenAttributeId', 'TreeScope_Ancestors',
    'AnnotationType_TrackChanges', 'IUIAutomationTextPattern',
    'UIA_ItemContainerPatternId', 'UIA_IsItalicAttributeId',
    ...
    'TextEditChangeType_None', 'UIA_WindowPatternId',
    'UIA_HeaderControlTypeId', 'IUIAutomationObjectModelPattern',
    'UIA_RotationPropertyId',
    'UIA_IsSelectionPattern2AvailablePropertyId',
    'AnnotationType_DataValidationError', 'UIA_MenuClosedEventId',
    'UIA_MarginLeadingAttributeId', 'UIA_NamePropertyId',
    'UIA_ControllerForPropertyId',
    'UIA_IsTextEditPatternAvailablePropertyId',
    'UIA_IsSubscriptAttributeId', 'UIA_ThumbControlTypeId',
    'UIA_FrameworkIdPropertyId', 'IUIAutomationCacheRequest',
    'UIA_DataItemControlTypeId',
    'StructureChangeType_ChildrenBulkRemoved',
    'UIA_IsInvokePatternAvailablePropertyId',
    'UIA_HelpTextPropertyId', 'UIA_Transform2ZoomMaximumPropertyId',
    'IUIAutomationElement4', 'UIA_DropTarget_DroppedEventId',
    'UIA_ToolTipClosedEventId', 'ScrollAmount_SmallDecrement',
    'UIA_TransformPattern2Id', 'AnnotationType_Unknown',
    'IUIAutomationPropertyCondition',
    'UIA_IsObjectModelPatternAvailablePropertyId',
    'UIA_CaretBidiModeAttributeId', 'IUIAutomationElement8',
    'LiveSetting', 'CUIAutomation8', 'IUIAutomationGridPattern',
    'IUIAutomationEventHandler', 'IUIAutomationElement6',
    'UIA_DragDropEffectPropertyId',
    'IUIAutomationSynchronizedInputPattern',
    'UIA_SizeOfSetPropertyId',
    'UIA_SelectionItemSelectionContainerPropertyId',
    'UIA_SelectionPatternId', 'UIA_StylesShapePropertyId',
    'UIA_TransformCanMovePropertyId', 'AnnotationType_GrammarError',
    'NavigateDirection_Parent', 'UIA_SelectionPattern2Id',
    'ExpandCollapseState_LeafNode', 'StyleId_Heading9',
    'IUIAutomationElement', 'StyleId_Heading3',
    'IUIAutomationSpreadsheetPattern', 'UIA_GridItemRowPropertyId',
    'UIA_ChangesEventId', 'HeadingLevel7',
    'UIA_LegacyIAccessibleValuePropertyId',
    'UIA_DescribedByPropertyId', 'StyleId_Heading1',
    'UIA_ToolTipOpenedEventId', 'OrientationType_None',
    'UIA_SpreadsheetItemFormulaPropertyId',
    'UIA_IsReadOnlyAttributeId', 'UIA_UnderlineStyleAttributeId',
    'AnnotationType_Header', 'UIA_ToolBarControlTypeId',
    'IUIAutomationWindowPattern', 'UIA_StylesFillColorPropertyId',
    'UIA_VisualEffectsPropertyId', 'ExpandCollapseState',
    'UIA_IsVirtualizedItemPatternAvailablePropertyId',
    'AnnotationType_SpellingError', 'DockPosition_Top',
    'UIA_StylesExtendedPropertiesPropertyId', 'StructureChangeType',
    'UIA_MultipleViewSupportedViewsPropertyId',
    'UIA_IsAnnotationPatternAvailablePropertyId',
    'UIA_SynchronizedInputPatternId', 'UIA_TreeControlTypeId',
    'RowOrColumnMajor_ColumnMajor', 'UIA_SpreadsheetPatternId',
    'UIA_InputReachedOtherElementEventId', 'IUIAutomationTreeWalker',
    'UIA_ClassNamePropertyId', 'TextUnit_Paragraph',
    'UIA_DockPatternId', 'OrientationType_Vertical',
    'IUIAutomationTextRange', 'UIA_FillTypePropertyId',
    'NavigateDirection_LastChild', 'TreeScope_Element',
    'TreeScope_None', 'UIA_Selection_InvalidatedEventId',
    'WindowInteractionState', 'UIA_ToggleToggleStatePropertyId',
    'UIA_StylesStyleNamePropertyId', 'UIA_IsPasswordPropertyId',
    'IUIAutomationProxyFactoryEntry', 'ZoomUnit_SmallDecrement',
    ...
    'StyleId_Heading6', 'UIA_PositionInSetPropertyId',
    'UIA_GridRowCountPropertyId', 'UIA_TabsAttributeId',
    'UIA_Transform2CanZoomPropertyId',
    'UIA_IsCustomNavigationPatternAvailablePropertyId',
    'UIA_ItemStatusPropertyId',
    'UIA_IsSelectionItemPatternAvailablePropertyId',
    'UIA_AnnotationPatternId',
    'UIA_IsTablePatternAvailablePropertyId', 'UIA_PaneControlTypeId',
    'UIA_Drag_DragCompleteEventId', 'UIA_TextEditPatternId',
    'UIA_Selection2ItemCountPropertyId',
    'SynchronizedInputType_KeyUp', 'AutomationElementMode_None',
    'UIA_WindowIsModalPropertyId', 'UIA_AnimationStyleAttributeId',
    'HeadingLevel4', 'NavigateDirection_NextSibling',
    'UIA_TabControlTypeId', 'UIA_SelectionItemPatternId',
    'AnnotationType_MoveChange', 'UIA_ForegroundColorAttributeId',
    'UIA_IsWindowPatternAvailablePropertyId',
    'StructureChangeType_ChildRemoved', 'UIA_ValueValuePropertyId',
    'IUIAutomationBoolCondition', 'IUIAutomationOrCondition',
...
_check_version('1.2.1', 1681253356.829799)
